...
Though it is worth noting that the independence seems to be a bigger term than in statistics. Independence of cause and mechanism - mechanism being \[p(t | a)\] and cause being \[p(a).\] If we start changing the cause distribution then the t -> a causal model does not keep the mechanism intact.
